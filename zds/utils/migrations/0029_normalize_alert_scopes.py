...
"""
En production, la colonne `scope` de la table qui stocke les alertes contient
des relicats d'anciennes versions de la gestion des alertes :
...
Cette migration homogénéise les scopes de toutes les alertes.
"""
